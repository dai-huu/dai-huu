...
- 🏆 **AWS Certified Solutions Architect - Associate** (Feb 2026) <a href="https://www.credly.com/badges/d7a7d23f-72b9-4bdb-99ef-551677a714c1/public_url" target="_blank"><i> Verify Credential</i></a>
...
- **[Jenkins-Ansible-CICD Pipeline](https://github.com/dai-huu/jenkins-ansible-cicd)** - Automated CI/CD with GitHub webhooks & AWS deployment
- **[VPN GRE Tunnel & IPsec](https://github.com/dai-huu/VPN_GRE_TUNNEL_IPSEC)** - Secure site-to-site VPN configuration
- **[Zabbix Monitoring System](https://github.com/dai-huu/ZABBIX-Performance-monitoring)** - Real-time infrastructure monitoring
- **[SAN Storage Deployment](https://github.com/dai-huu/SAN_Storage)** - TrueNAS with replication & backup
- **[Load Balancing with Nginx](https://github.com/dai-huu/Load-Balancing-NGINX)** - High-availability web server setup
- **[ARP Spoofing Attack Simulation](https://github.com/dai-huu/Timhieu_ARP_Spoofing)** - Network security lab
